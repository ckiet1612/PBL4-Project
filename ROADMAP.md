...
- Các chặng B07–B25 chưa được coi là hoàn thành.

Nguồn ghi nhận: phản hồi duyệt cuối của Task **Review** cho B01–B04, phản hồi hoàn tất của Task **B2 - Bootstrap**, [báo cáo B02](docs/evidence/B02-bootstrap.md), [báo cáo B03](docs/evidence/B03-simulator.md), [báo cáo triển khai B04](docs/evidence/B04-fairness.md), [evidence triển khai B05](docs/evidence/B05-postgresql.md), xác nhận của user ngày 20/09/2026 rằng Task **Review** đã duyệt B05, [evidence triển khai B06](docs/evidence/B06-identity-token-rbac.md) và xác nhận của user ngày 20/09/2026 rằng Task **Review** đã duyệt B06. Các báo cáo triển khai được lập trước quyết định duyệt có thể còn ghi chờ review; trạng thái B05 và B06 ở đây đã được cập nhật theo xác nhận mới nhất của user. B07 đủ điều kiện bắt đầu từ B06; B09 đủ điều kiện bắt đầu từ B02. B11 đã đủ phần B04 nhưng vẫn phải chờ B08 và B10 hoàn thành.
...
| B07 | Artifact store và upload bền vững | Tạo nơi lưu tệp đầu vào, điểm lưu giữa chừng và kết quả. Tệp tải dở khi gặp lỗi không bị coi là tệp đã lưu hoàn chỉnh. | B06 |
| B08 | Submit, idempotency, durable queue | Nhận yêu cầu, ghi vào hàng chờ còn giữ được sau khởi động lại; gửi lại cùng yêu cầu không tạo thêm công việc trùng. Từ chối rõ ràng khi hết chỗ hoặc vượt giới hạn. | B07 |

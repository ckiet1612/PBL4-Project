...
| `src/nexa/coordinator/` | B11 leadership, B04 snapshot/accounting tick và allocation/dispatch; reaper/recovery thuộc B15 | Scheduler/application + persistence; recheck dưới transaction; không điều khiển Docker trực tiếp | B11, B13, B15 |
